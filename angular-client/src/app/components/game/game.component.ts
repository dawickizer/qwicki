...
export class GameComponent implements OnInit {
  ...
  constructor(private gameService: GameService, private authService: AuthService, private keyBindService: KeyBindService) { }
  ...
  async ngAfterViewInit() {
    ...
    this.authService.currentUser().subscribe({
      next: async user => {
        ...
        await this.gameService.addFpsMechanics(this.scene, this.canvas, this.username);
